...
프리거슨은 이러한 상변화 열전달(비등·응축) 최적화 기술과 나노/마이크로 표면 제조 역량을 바탕으로, Cold Plate 내부에서 효율적인 상변화 열전달이 일어나도록 유로와 표면 구조를 설계합니다. 대학·연구소에서 유사한 상변화 열전달 실험 셋업이 필요하시다면 [Workshop]({{ '/workshop/' | relative_url }})에서 함께 구성해 드릴 수 있습니다.
